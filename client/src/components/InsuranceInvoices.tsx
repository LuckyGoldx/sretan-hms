...
export default function InsuranceInvoices() {
  ...
  function printInvoice(inv: any, items: any[]) {
    ...
    w.document.write(`<!DOCTYPE html><html><head><title>${inv.invoice_number}</title>
      ...
      <div class="header">
        <div><div class="logo">🛡️ Sretan HMS Insurance</div><p class="sub">Invoice #<strong>${inv.invoice_number}</strong></p></div>
        <div class="meta">
      ...
      <p style="margin-top:30px;text-align:center;color:#94a3b8;font-size:10px">Generated by Sretan HMS Insurance Module · ${new Date().toISOString().slice(0, 10)}</p>
      </body></html>`)
    w.document.close()
